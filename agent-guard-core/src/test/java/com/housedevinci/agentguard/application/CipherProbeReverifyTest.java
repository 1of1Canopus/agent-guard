...
class CipherProbeReverifyTest {
   ...
   *
   * <p><b>Ruling on QUESTIONS.md #20 (Dollar):</b> a row-embedded version scheme can never tell a
   ...
   * Cipher R4). {@link AuditChainVerifier#verify()} requires every row before {@code
   ...
   * probe_a_keyed_trail_verifies_after_it_is_rewritten_as_unkeyed}) and Cipher's original
  ...
  /**
   * V2, Cipher's original repro restored (Dollar's ruling, QUESTIONS.md #20): not a downgraded tail
