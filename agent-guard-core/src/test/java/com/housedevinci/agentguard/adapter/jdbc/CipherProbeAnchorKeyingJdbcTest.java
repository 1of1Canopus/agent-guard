...
/**
 * the security review final-verification probes against the V2 fix's new surface: {@code
 * agentguard_audit_anchor.keyed_from_seq} (QUESTIONS.md #20). The {@code probe_*} tests assert
 * today's — broken — behaviour so the suite stays green; engineering flips each assertion when the fix
