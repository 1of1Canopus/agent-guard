...
public interface AuditAnchor {
   ...
   *     used a keyed chain, and immutable afterwards (the anchor's monotonic trigger, Cipher R4,
   ...
   *     legitimately-unkeyed prefix apart from a downgraded one (Cipher V2 / QUESTIONS.md #20): the
